const API_ENDPOINT2: string = "";

const PUBLISHED_THEME_CARD: string = `
...
function onPublishHandler() {
    const submitBtn: HTMLButtonElement | null = document.querySelector("#publish-theme-btn");
    const themeNameField: HTMLInputElement | null = document.querySelector("#theme-name");
    const themeDescField: HTMLInputElement | null = document.querySelector("#theme-desc");
    const themeDataField: HTMLInputElement | null = document.querySelector("#theme-data");
...
function addListing(themeName: string, listingsContainer: HTMLDivElement) {
...
function refreshThemeListings() {
    const themesContainer: HTMLDivElement | null = document.querySelector("#my-themes");
    if (themesContainer == null) return;
    ...
    fetch(`${API_ENDPOINT2}/api/v1/themes/get_owned`, {
        ...
        .then(data => {
            ...
            const listings: string[] = data.data;
